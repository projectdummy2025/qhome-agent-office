    ...
    try:
        ...
        try:
            ...
            res_json = (
                json.loads(match.group(0))
                if match
                else {"reasoning": response.content.strip(), "area_m2": 15.0}
            )
        ...
        content = (
            "Maaf, saya tidak menemukan produk panel kayu yang sesuai di database."
        )
        product_data = {
            "sku": "OOS-WOOD",
            "name": "Menunggu Konfirmasi",
    ...
    try:
        ...
        try:
            ...
            res_json = (
                json.loads(match.group(0))
                if match
                else {"reasoning": response.content.strip(), "area_m2": 12.0}
            )
        ...
        content = (
            "Maaf, saya tidak menemukan cat interior yang spesifik sesuai permintaan."
        )
        product_data = {
            "sku": "OOS-PAINT",
            "name": "Menunggu Konfirmasi",
